	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link active" href="/personnel-login">Fraud Analysis Personnel</a></li>
...
<div class="container">
    Don't have an account? <a href="/personnel-registration">Click here</a>
