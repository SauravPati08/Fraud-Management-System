<%@ include file="../common/header.jspf"%>
    ...
    <div class="container">
        ...
        <table class="table caption-top table-striped">
            ...
            <tbody>
                <c:forEach items="${transaction}" var="c">
                    <tr>
                        <td>${c.userId}</td>
                        <td>${c.cardHolderName}</td>
                        <td>${c.accNo}</td>
                        <td>${c.cardNo}</td>
                        <td><a href="/transaction-updateForm?id=${c.userId}" type="button" class="btn btn-success">Update</a></td>
                        <td><a href="/transaction-delete?id=${c.userId}" type="button" class="btn btn-warning">Delete</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
